...
KafkaMessageFactory.instance.registerMessageClasses([
  ...
  },
  {
    ...
    messageType: MessageParams._messageType,
    messageCategory: MessageCategories.Message,
    classType: MessageParams,
  },
  {
    protocol: VehicleLocationMessageParams._protocol,
    messageType: VehicleLocationMessageParams._messageType,
    messageCategory: MessageCategories.Message,
    classType: VehicleLocationMessageParams,
  },
]);
