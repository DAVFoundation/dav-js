...
KafkaMessageFactory.instance.registerMessageClasses([
  ...
  {
    protocol: DroneStatusMessageParams._protocol,
    messageType: DroneStatusMessageParams._messageType,
    messageCategory: MessageCategories.Message,
    classType: DroneStatusMessageParams,
  },
]);
