...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void register_vehicle(VehicleDetails vehicleDetails)")
  fmt.Fprintln(os.Stderr, "  void deregister_vehicle(DAVUser vehicleID)")
  fmt.Fprintln(os.Stderr, "  bool vehicle_is_registered(DAVUser vehicleID)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := registration.NewRegistrationClientFactory(trans, protocolFactory)
  ...
  case "register_vehicle":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "RegisterVehicle requires 1 args")
      flag.Usage()
    }
    arg8 := flag.Arg(1)
    ...
    argvalue0 := vehicle.NewVehicleDetails()
    ...
    value0 := argvalue0
    fmt.Print(client.RegisterVehicle(value0))
    fmt.Print("\n")
    break
  case "deregister_vehicle":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "DeregisterVehicle requires 1 args")
      flag.Usage()
    }
    arg14 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.DeregisterVehicle(value0))
    fmt.Print("\n")
    break
  case "vehicle_is_registered":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "VehicleIsRegistered requires 1 args")
      flag.Usage()
    }
    arg20 := flag.Arg(1)
    ...
    value0 := argvalue0
    fmt.Print(client.VehicleIsRegistered(value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
